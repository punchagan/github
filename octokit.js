          ...
          Repository = (function() {
            function Repository(options) {
              ...
              this.getIssues = function(state) {
                ...
                return _request('GET', "" + this.repoPath + "/issues?state=" + state, null);
              };
              this.getIssue = function(number) {
                return _request('GET', "" + this.repoPath + "/issues/" + number, null);
              };
              this.getComments = function(number) {
                return _request('GET', "" + this.repoPath + "/issues/" + number + "/comments", null);
              };
              this.createComment = function(number, body) {
                return _request('POST', "" + this.repoPath + "/issues/" + number + "/comments", {
                  body: body
                });
              };
              this.createIssue = function(title, body) {
                ...
                return _request('POST', "" + this.repoPath + "/issues", {
                  title: title,
                  body: body
                });
              };
